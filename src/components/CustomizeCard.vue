    ...
    <div class="settings">
        <form>
            <div>
                ...
                <input type="text" placeholder="introducir color de fondo de figura." v-model="card.bgColor">
            </div>
            <br>
            <div>
                <label for="bgColor">Color de texto:</label>
                <input type="text" placeholder="introducir color del texto de la figura." v-model="card.txtColor">
            </div>
           <br>
           <div>
           ...
           <div>
            ...
            <input type="range" name="borderRange" id="borderRange" min="1" max="50" v-model="card.borderSize"/>
           </div>
            <br>
            <div>
            <label for="text">Contenido textual:</label>
            <br>
            <textarea id="text" rows="6" cols="30" v-model="card.text" placeholder="Introduzca el texto que quiere colocar en la tarjeta"></textarea>
            </div>
            <br>
            <div>
            ...
            <br>
            <div>
                <input type="checkbox" name="opaque" id="opaque" v-model="isTransparent" checked>
            ...
            <div>
                ...
                <input type="radio" :value="card.fontSize[1]" v-model="card.fontSizeSelected" id="regular">
